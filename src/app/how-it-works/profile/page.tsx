...
export default function HowItWorksProfilePage() {
  return (
    <article className="rounded-3xl border border-white/10 bg-zinc-900/35 p-6 sm:p-8">
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-zinc-400 sm:text-base">
        <p>
          Pick your role, describe your sound or room, add location so people nearby can
          find you, and use prompts that make it easy to start the right conversation.
        </p>
      </div>
    </article>
  );
